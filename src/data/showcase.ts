...
export const SHOWCASE_TROPHIES: PublicTrophy[] = [
  ...
  {
    slug: 'uefa-womens-euro-silver-normals',
    name: 'UEFA Trophy — Silver (Correct Normals)',
    description: 'Silver with outward-facing normals fix.',
  ...
  {
    slug: 'uefa-womens-euro-crystal-normals',
    name: 'UEFA Trophy — Crystal (Correct Normals)',
    description: 'Crystal material with outward-facing normals fix.',
